...
import 'package:test_app/screens/my_lessons.dart';
import 'package:test_app/size_config.dart';

import '../background.dart';
import 'my_courses.dart';

class AccessExpired extends StatelessWidget {

  final String courseTitle;
  final String heading;

   AccessExpired({Key key, this.courseTitle, this.heading}) : super(key: key);
      ...
      body: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              bottom: 20*SizedConfig.heightMultiplier, //Have to fix
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(this.courseTitle,style: TextStyle(fontSize: 4.5*SizedConfig.heightMultiplier,color: Colors.white,fontWeight: FontWeight.w500),),
                      ),
                      Container(
                        child: Column(
                          children: [
                            Container(
                              height: 28*SizedConfig.heightMultiplier,
                              width : double.infinity,
                              decoration: BoxDecoration(
                                color: Colors.white,
                                image: DecorationImage(
                                  image: AssetImage("assets/images/access_expired.png"),
            ...
            //Request access and Go back buttons
            Positioned(
  ...
  Widget bottomSheet(BuildContext context){
    return Container(
      height: 40*SizedConfig.heightMultiplier,
      decoration: BoxDecoration(
      ...
      child: Column(
        children: [
          Container(
            height: 25*SizedConfig.heightMultiplier,
            decoration: BoxDecoration(
              image: DecorationImage(
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  child: Container(
                    width: 36*SizedConfig.widthMultiplier,
                    alignment: Alignment.center,
                    padding: EdgeInsets.symmetric(vertical: 1.5*SizedConfig.heightMultiplier),
                    decoration: BoxDecoration(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(FontAwesomeIcons.arrowLeft,color: Colors.white,size: 3.5*SizedConfig.heightMultiplier,),
                        SizedBox(width: 2.5*SizedConfig.widthMultiplier),
                        Text("Go Back",style: TextStyle(fontSize: 3*SizedConfig.heightMultiplier,fontWeight: FontWeight.w800,color: Colors.white))
                      ],
                    )
                  ),
                  onTap: (){
