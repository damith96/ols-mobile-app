...
import 'package:test_app/search_widget.dart';
...
class _MyCoursesState extends State<MyCourses> {
  ...
  Future<void> getMyCourses() async{
    ...
    var res = await NetworkRequest().getData('/api/v1/courses/my/$id');
                            ...
                            child: Container(
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index){
                                    ...
                                    return buildItems(text,resList[index]['thumbnail_image'],resList[index]['id']);
                                  }
                              )      ,
                            ),
                          )
  ...
  Widget buildItems(String text,String url,int courseId) {
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context){
                internetSubscription.cancel();
                return MyLessons(title: text,courseId: courseId,);
              }
          ));
        }
      ),
